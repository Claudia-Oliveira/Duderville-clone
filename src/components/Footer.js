                ...
                <div className={styles.footer__container}>
                    <div className={styles.footer__block}>
                        <div className={styles.footer__logo}>
                            <Button href="/">
                                <svg className={styles.footer__logo_svg} viewBox="0 0 46.46 79.59">
                                    <path
                    ...
                    <div className={styles.footer__block}>
                        <ul className={`${styles.list} ${styles.footer__block_ul}`}>
                            <li className={styles.footer__block_li}>
                                <span className={styles.footer__block_title}>{t('footer:general-title')}</span>
                                <Button className={styles.footer__block_link} href="mailto:hi@dunderville.se">
                                    {t('footer:general-email')}
                                </Button>
                                <span className={styles.footer__block_phone}>{t('footer:general-phone')}</span>
                            </li>
                        </ul>

                        <ul className={`${styles.list} ${styles.footer__block_ul}`}>
                            <li className={styles.footer__block_li}>
                                <span className={styles.footer__block_title}>{t('footer:address-title')}</span>
                                <Button
                                    className={styles.footer__block_link_maps}
                                    href="https://www.google.com/maps/place/Dunderville+AB/@55.6123845,12.9915055,15z/data=!4m5!3m4!1s0x0:0x191111d421f84e6d!8m2!3d55.6123845!4d12.9915055"
                                    target="_blank"
                                >
                                    <span className={styles.footer__block_info}>{t('footer:company-name')}</span>
                                    <span className={styles.footer__block_info}>{t('footer:street')}</span>
                                    <span className={styles.footer__block_info}>{t('footer:city')}</span>
                                </Button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className={styles.footer__block}>
                        <ul className={`${styles.list} ${styles.footer__block_ul}`}>
                            <li className={styles.footer__block_li}>
                                <span className={styles.footer__block_title}>{t('footer:producer-title-first')}</span>
                                <Button className={styles.footer__block_link} href="mailto:erik@dunderville.se">
                                    {t('footer:producer-email-first')}
                                </Button>
                                <span className={styles.footer__block_phone}>{t('footer:producer-phone-first')}</span>
                            </li>
                        </ul>

                        <ul className={`${styles.list} ${styles.footer__block_ul}`}>
                            <li className={styles.footer__block_li}>
                                <span className={styles.footer__block_title}>{t('footer:producer-title-second')}</span>
                                <Button className={styles.footer__block_link} href="mailto:jonas@dunderville.se">
                                    {t('footer:producer-email-second')}
                                </Button>
                                <span className={styles.footer__block_phone}>{t('footer:producer-phone-second')}</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className={styles.footer__block}>
                        <ul className={`${styles.list} ${styles.footer__block_ul}`}>
                            <li className={styles.footer__block_li}>
                                <span className={styles.footer__block_title}>{t('footer:web-title')}</span>
                                <Button className={`${styles.footer__block_link} ${styles.footer__block_link_social_media}`} href="https://www.instagram.com/dunderville_ab/" target="_blank">
                                    {t('footer:web-instagram-link')}
                                    <svg className={styles.footer__arrow} viewBox="0 0 17 18">
                                ...
                                <Button className={styles.footer__block_link} href="https://vimeo.com/dunderville" target="_blank">
                                    {t('footer:web-vimeo-link')}
